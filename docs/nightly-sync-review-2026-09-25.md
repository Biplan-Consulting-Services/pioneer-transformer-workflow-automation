...
**v003 (being generated) changes C1 to `Location eq 'Livraison' and ItemStatus eq 'Delivered'`** (the trigger flow's
...
## 6b. v002 is built and STAGED (2026-09-25 01:03). ⚠️ SUPERSEDED by v003, see §6a. Do not paste v002.
