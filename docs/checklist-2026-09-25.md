...
- [ ] **Nightly Sync** (`docs/nightly-sync-review-2026-09-25.md`): read §2–§5 and answer **N1–N5** (§6). Your v001 visits
      ...
      archive row alone with no cap or log, and has no TODAY() recalc. **v003 is being generated** (v002 withdrawn: it filtered on Delivery End Date, empty on every unit; review doc §6a) (`workflow-data/Order Items - Nightly Sync/_outbox/PASTE-ME.json`; paste + test steps in the review doc §6b) for you to
