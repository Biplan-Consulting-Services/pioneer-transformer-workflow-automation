...
**v003 — v003: C1 = Livraison AND Delivered (DeliveryDate empty on every unit); Excel clock >=7d; report Excel-vs-list disagreements; dry run, cap 50; supersedes v002 (never pasted)**
